...
public class ChangeBigLettersToSmall {
    public static void main(String[] args) {
        changeBigLettersToSmall(); //calling changeBigLettersToSmall from the method main
    }
    public static void changeBigLettersToSmall() { //creating method changeBigLettersToSmall
