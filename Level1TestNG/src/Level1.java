...
//        findFirstMaxElementOfArray();
    ...
    public static int countSpecificElements() {
        ...
        int[] array = new int[n];// created array with n cells
    ...
    public static int[] countOfZeronumbersinarray() {
        ...
        int[] array2 = new int[b]; // creating new array2 with b - the number of elements in this array
        for (int i = 0; i < array.length; i++) {
            if (array[i] == 0) {
                array2[j] = i; //filling in array2 with indexes заполняем второй массив индексами нулей
                j++; // incrementally increase
            }
        }
        for (int k = 0; k < array2.length; k++) { //printing out the array of k.
    ...
    public static String findWhichIsFirstPositiveorNegative() {
    ...
    public static int[] createArrayOfEvenNumbers() {
     ...
     */
    public static int changeAllElementsToZ() {
     ...
     */
    public static String calculateTheNumberOfPositiveNegativeNulls() {
    ...
    public static int[] changeBiggestWithSmallest() {
