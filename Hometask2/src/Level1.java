...
public class Level1 {
    public static void main(String[] args) {
        ...
        changeBiggestWithSmallest();
        printOnlyArrayIisLessOrEqualToI();
        printAllModuleEqualsM();
        changeElementsPlaces();
        printAllIncludingNull();
        findMaxEvenPlusMinOdd();
        findMultiplOfNumbersBuggerThenM();
        findbiggestnumberbyModule();
        findMultiplOfMinAnMinusNumbers();
        findFirstMaxElementOfArray();
        createNewArrayWhenEndsK();
    }
    ...
    public static void countSpecificElements() {
        ...
        int[] array1 = new int[n];// created array with n cells
        for (int i = 0; i < array1.length; i++) { //for elements from 0 to 15
            array1[i] = i; //  assign number to each element of array1
        }
        for (int i = 0; i < n; i++) // check if array is divisible to k
            if (array1[i] % k == 0)
                arraySum = arraySum + array1[i]; // Calculate the sum of array1[i] numbers tha are divisible by 5
    ...
    public static void countOfZeronumbersinarray() {
        int[] array2 = {0, 33, 2, 5, 63, 3, 0, 0, 3, 0, 3, 3, 1, 0};
        int j = 0;
        int b = 0;
        for (int i = 0; i < array2.length; i++) { //calculate the number of zeros in array2
            if (array2[i] == 0)
                b++; // b is the variable for counting the number of zeros in array
        }
        int[] array3 = new int[b]; // creating new array3 with b - the number of elements in this array
        for (int i = 0; i < array2.length; i++) {
            if (array2[i] == 0) {
                array3[j] = i; //filling in array3 with values
                j++; // incrementally increase
            }
        }
        for (int k = 0; k < array3.length; k++) { //printing out the array of k.
    ...
    public static void findWhichIsFirstPositiveorNegative() {
        int[] array4 = {0, 0, -2, -4, 24, 53};
        int firstNumber = 0;
        for (int i = 0; i < array4.length; i++) {
            if (array4[i] != 0) {
                firstNumber = array4[i];// taking number from array4 which is not equal to 0 and assigning it to variable firstNumber
    ...
    public static void createArrayOfEvenNumbers() {
     ...
     */
    public static void changeAllElementsToZ() {
     ...
     */
    public static void calculateTheNumberOfPositiveNegativeNulls() {
    ...
    public static void changeBiggestWithSmallest() {
    ...
    //10. Дан массив. Вывести на печать только те числа, для которых выполняется условие arr[i]<=i. (array[1]=2- значит 1-й элемент массива равен 2) NOT DONE YET!
    public static void printOnlyArrayIisLessOrEqualToI() {
    ...
    public static void printAllModuleEqualsM() {
    ...
    public static void changeElementsPlaces() {
        int[] array = {25, 12, 2, 1, 4, 1, 4, 11, 44};
    ...
    public static void printAllIncludingNull() {
    ...
    public static void findMaxEvenPlusMinOdd() {
    ...
    public static void findMultiplOfNumbersBuggerThenM() {
    ...
    public static void findbiggestnumberbyModule() {
    ...
    public static void findMultiplOfMinAnMinusNumbers() {
        ...
        else System.out.println("Multiplication of plus numbers is bigger");

    }

    // 18 Дан массив чисел. Среди них есть равные. Найти первый максимальный элемент массива и заменить его нулем.
    public static void findFirstMaxElementOfArray() {
    ...
    public static void createNewArrayWhenEndsK(){
        int[] array = {2, -5, 45, 2, -1, 5, 16, 10, 125, 1015, 45, 5, 12505};
        int k=5; //  2%5=0.4. Значит что результат будет 4.
        for (int i=0;i<array.length;i++){
            if (array[i]%10==5){ // делю по модулю на 10 чтоб найти остаток от деления. Если остаток от деления равен 5, то это значит что число заканчивается на 5. В данном случае на 5 нельзя делить, так как 10/5 будет равно 5
